...
#
# Script generated by Vivado on Mon Sep 07 17:27:16 +1000 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/garwo/Dev/EthernetStack/EthernetStack/EthernetStack.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
